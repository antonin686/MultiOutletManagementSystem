...
@endif
 <form method="POST" class="container shadow-lg p-3 mb-5 bg-blue rounded" style="opacity:0.9;background:white" action="{{route('addEmployee')}}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="salary" name="salary" value="{{old('salary')}}" aria-describedby="" placeholder="Salary">
        </div>
        <div class="form-group">
